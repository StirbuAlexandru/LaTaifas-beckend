...
export default function AllProductsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Toate Produsele</h1>
        <p className="text-gray-600">Descoperă întreaga gamă de produse disponibile</p>
      </div>
