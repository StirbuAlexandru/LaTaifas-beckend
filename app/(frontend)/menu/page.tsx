      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="md:w-1/4">
            <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-24 border-2 border-red-100">
              ...
              <div className="space-y-2">
                {categories.map((category) => (
                  <Button
                    ...
                    className={`w-full justify-start text-left group relative overflow-hidden transition-all duration-300 ${
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-red-100">
              <div className="mb-6 pb-6 border-b-2 border-red-100">
                ...
                {currentCategory?.note && (
                  <p className="text-sm italic text-gray-600 ml-11 bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-r-lg">
                    {currentCategory.note}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-6">
                {items.length === 0 ? (
                  ...
                  items.map((item, index) => (
                    <div 
                      key={item.id} 
                      className="group border-b-2 border-gray-100 pb-6 last:border-0 hover:bg-red-50/50 -mx-4 px-4 py-4 rounded-lg transition-all duration-300"
                      style={{ animationDelay: `${index * 0.05}s` }}
                    >
                      <div className="flex items-start gap-3">
                        <div className="bg-gradient-to-br from-red-100 to-red-200 p-2 rounded-lg mt-1 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="flex-1">
                          <div className="mb-2">
                            ...
                            {item.details && (
                              <span className="text-gray-600 ml-2 text-base">{item.details}</span>
                            )}
                          </div>
                          {item.ingredients && (
