...
export default function BurgersCategoryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        // Fetch burgers products from API
        const response = await fetch('/api/products?categoryId=2'); // Assuming category ID 2 is burgers
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Burgers</h1>
        <p className="text-gray-600">Burgere delicioase preparate cu ingrediente proaspete</p>
      </div>
