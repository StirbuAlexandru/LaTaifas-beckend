...
export default function PizzaCategoryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        // Fetch pizza products from API
        const response = await fetch('/api/products?categoryId=1'); // Assuming category ID 1 is pizza
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">Pizza</h1>
        <p className="text-gray-600">Delicioase pizza preparate cu ingrediente proaspete</p>
      </div>
